...
export default function Sports() {
  ...
  const itemsPerPage = 8; // Ek page pe 8 items dikhayenge

  useEffect(() => {
    fetch("https://puma-react.onrender.com/Sports")
      .then((res) => res.json())
      .then((data) => {
        setState(data);
      });
      ...
      <div className="row g-4">
        {currentItems.map((el) => (
          <div className="col-md-3" key={el.id}>
            <Link to={`/HomePage4/${el.category}/${el.id}`} className="text-decoration-none">
