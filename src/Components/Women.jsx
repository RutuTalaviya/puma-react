...
export default function Women() {
  ...
  const itemsPerPage = 8; // Per page kitne items dikhane hain

  useEffect(() => {
    fetch("https://puma-react.onrender.com/Women")
      .then((res) => res.json())
      .then((data) => {
        setState(data);
      });
      ...
      <div className="row g-4">
        {currentItems.map((el) => (
          <div className="col-md-3" key={el.id}>
            <Link to={`/HomePage2/${el.category}/${el.id}`} className="text-decoration-none">
